...
conditions_state = {
    ...
    "total_registered_votes_table": f"""{presidential_table_state['query']} select  constituency_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted,remarks FROM  st""",
    ...
    "canceled_table": f"""{presidential_table_state['query']} SELECT constituency_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted,remarks FROM  st where status ='canceled' """,
    ...
    "collated_table": f"""{presidential_table_state['query']} SELECT  constituency_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted,remarks  FROM  st WHERE  (status = 'collated' OR status='canceled')""",
    ...
    "un_collated_table":f"""{presidential_table_state['query']} SELECT  constituency_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted,remarks FROM  st where status='non collated'""",
    ...
    "over_voting_table":f"""{presidential_table_state['query']} SELECT constituency_name,over_vote_values,remarks,percentage_voters_turnout  FROM  st WHERE over_vote_values>0""",
...
# state results
def get_state_state_all_results(state_name="undefined",constituency_name="undefined"):
    with get_db2() as conn:
        ...
        if constituency_name and constituency_name != "undefined":
            state_query = f" AND const_id={constituency_name}"
