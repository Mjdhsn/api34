...
conditions_ward = {
    ...
    "total_registered_votes_table": f"""{presidential_table_ward['query']} select  ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted,remarks FROM wt""",
    ...
    "canceled_table": f"""{presidential_table_ward['query']} SELECT ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted,remarks FROM wt where status ='canceled' """,
    ...
    "collated_table": f"""{presidential_table_ward['query']} SELECT  ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted,remarks  FROM wt WHERE  (status = 'collated' OR status='canceled')""",
    ...
    "un_collated_table":f"""{presidential_table_ward['query']} SELECT  ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted,remarks FROM wt where status='non collated'""",
...
conditions_lga = {
    "total": f"""{presidential_table_ward['query']} SELECT COUNT(*) as  count1 FROM wt""",
    "total_registered_votes_table": f"""{presidential_table_ward['query']} select lga_name, ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted FROM wt""",
    "total_registered_votes": f"""{presidential_table_ward['query']} SELECT COALESCE(sum(Total_Registered_voters),0) as  count1 FROM wt""",
    "canceled": f"""{presidential_table_ward['query']} SELECT count(*) as  count1 FROM wt where status ='canceled' """,  
    "canceled_table": f"""{presidential_table_ward['query']} SELECT lga_name,ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted FROM wt where status ='canceled' """,
    "total_registered_canceled_voters": f"""{presidential_table_ward['query']} select COALESCE(sum(Total_Registered_voters),0) as  count1 FROM wt where status ='canceled' """ ,   
    "collated": f"""{presidential_table_ward['query']}   SELECT sum(case when status = 'collated' OR status = 'canceled' then 1 else 0 end) as  count1 FROM wt""",
    "collated_table": f"""{presidential_table_ward['query']} SELECT  lga_name,ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted  FROM wt WHERE  (status = 'collated' OR status='canceled')""",
    "total_registered_collated_voters": f"""{presidential_table_ward['query']} select COALESCE(sum(Total_Registered_voters),0) as  count1 FROM wt where (status = 'collated' OR status='canceled')""",
    "un_collated": f"""{presidential_table_ward['query']} SELECT COUNT(*) as  count1   FROM wt where status='non collated'""",
    "un_collated_table":f"""{presidential_table_ward['query']} SELECT  lga_name,ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted FROM wt where status='non collated'""",
    "total_registered_uncollated_voters": f"""{presidential_table_ward['query']} select COALESCE(sum(Total_Registered_voters),0) as  count1 FROM wt where status='non collated'""",
...
conditions_state = {
    "total": f"""{presidential_table_ward['query']} SELECT COUNT(*) as  count1 FROM wt""",
    "total_registered_votes_table": f"""{presidential_table_ward['query']} select state_name,lga_name, ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted FROM wt""",
    "total_registered_votes": f"""{presidential_table_ward['query']} SELECT COALESCE(sum(Total_Registered_voters),0) as  count1 FROM wt""",
    "canceled": f"""{presidential_table_ward['query']} SELECT count(*) as  count1 FROM wt where status ='canceled' """,  
    "canceled_table": f"""{presidential_table_ward['query']} SELECT state_name,lga_name,ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted FROM wt where status ='canceled' """,
    "total_registered_canceled_voters": f"""{presidential_table_ward['query']} select COALESCE(sum(Total_Registered_voters),0) as  count1 FROM wt where status ='canceled' """ ,   
    "collated": f"""{presidential_table_ward['query']}   SELECT sum(case when status = 'collated' OR status = 'canceled' then 1 else 0 end) as  count1 FROM wt""",
    "collated_table": f"""{presidential_table_ward['query']} SELECT  state_name,lga_name,ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted  FROM wt WHERE  (status = 'collated' OR status='canceled')""",
    "total_registered_collated_voters": f"""{presidential_table_ward['query']} select COALESCE(sum(Total_Registered_voters),0) as  count1 FROM wt where (status = 'collated' OR status='canceled')""",
    "un_collated": f"""{presidential_table_ward['query']} SELECT COUNT(*) as  count1   FROM wt where status='non collated'""",
    "un_collated_table":f"""{presidential_table_ward['query']} SELECT  state_name,lga_name,ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted FROM wt where status='non collated'""",
    "total_registered_uncollated_voters": f"""{presidential_table_ward['query']} select COALESCE(sum(Total_Registered_voters),0) as  count1 FROM wt where status='non collated'""",
    "total_registered_voters": f"""{presidential_table_ward['query']}SELECT Total_Registered_voters  FROM st""",
    # "total_accredited_voters": f"""{presidential_table_ward['query']}SELECT Total_Accredited_voters  from st""",
    "total_rejected_votes": f"""{presidential_table_ward['query']}SELECT Total_Rejected_votes   from st """,
    "total_valid_votes": f"""{presidential_table_ward['query']}SELECT total_valid_votes  from st """,
    "total_vote_casted": f"""{presidential_table_ward['query']}SELECT total_vote_casted  from st""",
    "percentage_voters_turnout": f"""{presidential_table_ward['query']}SELECT percentage_voters_turnout  from st""",
    "over_voting": f"""{presidential_table_ward['query']} SELECT count(*)  as count1 FROM wt WHERE over_vote_values>0""",
    "over_voting_table":f"""{presidential_table_ward['query']} SELECT state_name,lga_name,ward_name,over_vote_values,remarks,percentage_voters_turnout  FROM wt WHERE over_vote_values>0""",
    "total_over_voting": f"""{presidential_table_ward['query']} select COALESCE(sum(over_vote_values),0) as over_votes_figuers FROM wt WHERE over_vote_values>0""",
    "party_graph":f"""{presidential_table_ward['query']} SELECT ROW_NUMBER() OVER(PARTITION BY state_name ORDER BY votes DESC) AS row_num,party,votes,	
...
conditions_country = {
    ...
    "un_collated_table":f"""{presidential_table_ward['query']} SELECT  state_name,lga_name,ward_name, Total_Registered_voters,total_valid_votes,Total_Rejected_votes,total_vote_casted FROM wt where status='non collated'""",
    "total_registered_uncollated_voters": f"""{presidential_table_ward['query']} select COALESCE(sum(Total_Registered_voters),0) as  count1 FROM wt where status='non collated'""",
    "total_registered_voters": f"""{presidential_table_ward['query']}SELECT Total_Registered_voters  FROM ct""",
    # "total_accredited_voters": f"""{presidential_table_ward['query']}SELECT Total_Accredited_voters  from ct""",
    "total_rejected_votes": f"""{presidential_table_ward['query']}SELECT Total_Rejected_votes   from ct """,
    "total_valid_votes": f"""{presidential_table_ward['query']}SELECT total_valid_votes  from ct """,
    "total_vote_casted": f"""{presidential_table_ward['query']}SELECT total_vote_casted  from ct""",
  "percentage_voters_turnout": f"""{presidential_table_ward['query']}SELECT percentage_voters_turnout  from ct""",
    "over_voting": f"""{presidential_table_ward['query']} SELECT count(*)  as count1 FROM wt WHERE over_vote_values>0""",
    "over_voting_table":f"""{presidential_table_ward['query']} SELECT state_name,lga_name,ward_name,over_vote_values,remarks,percentage_voters_turnout  FROM wt WHERE over_vote_values>0""",
    "total_over_voting": f"""{presidential_table_ward['query']} select COALESCE(sum(over_vote_values),0) as over_votes_figuers FROM wt WHERE over_vote_values>0""",
    "party_graph":f"""{presidential_table_ward['query']} SELECT ROW_NUMBER() OVER(PARTITION BY country_name ORDER BY votes DESC) AS row_num,party,votes,	
         IFF(total_vote_casted>0, concat(round(votes/total_vote_casted*100,2),'%'),'Voting in progress...')  as percentage_votes_casted FROM win_c """
}
...
def get_ward_country_all_results(country_name="undefined"):
    with get_db2() as conn:
        ...
        map1 = ['COUNTRY_NAME','STATE_NAME','LGA_NAME','WARD_NAME']
        map2 = ['TOTAL_REGISTERED_VOTERS','TOTAL_VALID_VOTERS','TOTAL_REJECTED_VOTES','TOTAL_VOTE_CASTED']
        # map3 = ['REMARKS']
        map4 =['OVER_VOTE_VALUES','PERCENTAGE_VOTERS_TURNOUT']
        query =[]
