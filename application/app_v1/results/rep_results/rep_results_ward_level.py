...
from application.app_v1.results.rep_results.partytable import presidential_table_ward
import json
...
def get_ward_lga_all_results(country_name="undefined",state_name="undefined",constituency_name="undefined", lga_name="undefined",party_data={}):
    with get_db2() as conn:
        ...
        pu_result = f"""{presidential_table_ward['query']}  select ward_name,  NNPP, APC,  PDP,   LP, AA,  AAC, ADC,  A,  ADP,   APGA,  APM,  APP,  BP,  NRM,  PRP,  SDP,  YPP,  ZLP, 
...
def get_ward_state_all_results(country_name="undefined",state_name="undefined",constituency_name="undefined",party_data={}):
    with get_db2() as conn:
        cur = conn.cursor()
        ...
        state_result = f"""{presidential_table_ward['query']}  select constituency_name,  NNPP, APC,  PDP,   LP, AA,  AAC, ADC,  A,  ADP,   APGA,  APM,  APP,  BP,  NRM,  PRP,  SDP,  YPP,  ZLP, 
        ...
        pu_result = f"""{presidential_table_ward['query']} select lga_name,  NNPP, APC,  PDP,   LP, AA,  AAC, ADC,  A,  ADP,   APGA,  APM,  APP,  BP,  NRM,  PRP,  SDP,  YPP,  ZLP, 
