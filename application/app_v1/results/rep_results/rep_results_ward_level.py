...
from app.application.app_v1.results.rep_results.partytable import presidential_table_ward
import json
...
def get_ward_state_all_results(country_name="undefined",state_name="undefined",constituency_name="undefined",party_data={}):
    with get_db() as conn:
        ...
        state_result = f"""{presidential_table_ward['query']}  select house_name,  NNPP, APC,  PDP,   LP, AA,  AAC, ADC,  A,  ADP,   APGA,  APM,  APP,  BP,  NRM,  PRP,  SDP,  YPP,  ZLP, 
